...
export const INDUSTRIES = {
  commercial: {
    ...
    metaDescription:
      "Commercial cleaning and janitorial contracts for daycares, car dealerships, warehouses, and offices in North Wales, Ambler, Blue Bell, Fort Washington, and Philadelphia. Insured, background-checked crews. Free walkthrough.",
    eyebrow: "Commercial & Janitorial Cleaning",
    h1: "Commercial Cleaning in Montgomery County, PA",
    intro:
      "Nightly, weekly, and custom-schedule cleaning contracts for businesses across Montgomery County and the Philadelphia suburbs. One insured, background-checked team, one checklist, and one account manager who actually picks up the phone.",
    highlights: [
      ...
      { title: "Background-checked crews", text: "Every cleaner is vetted before they set foot in your building." },
    ...
    sections: [
      ...
      { title: "Offices", text: "Workstations, conference rooms, lobbies, kitchens, and restrooms on a nightly or weekly schedule." },
      { title: "Retail & showrooms", text: "Sales floors, fitting rooms, entryways, and glass kept customer-ready." },
      { title: "Medical & professional suites", text: "Waiting rooms, exam-room surfaces, and restrooms cleaned and disinfected on your schedule." },
    ],
    faqs: [
  ...
  daycare: {
    ...
    metaDescription:
      "Daycare and child care center cleaning in North Wales, Ambler, Blue Bell, Fort Washington, and Philadelphia. Child-safe products, high-touch disinfecting, background-checked crews, and multi-location contracts.",
    ...
    highlights: [
      ...
      { title: "Background-checked crews", text: "Every cleaner is vetted, and whenever possible the same team services your center." },
    ...
    sections: [
      ...
      { title: "Restrooms & changing areas", text: "Toilets, child-height sinks, changing tables, fixtures, and floors cleaned and disinfected; dispensers restocked." },
    ...
    faqs: [
      ...
      { q: "Are your cleaners background-checked?", a: "Yes. Every team member is background-checked before they start, and we try to keep the same crew at your center so you always know who is in your building." },
  ...
  dealership: {
    ...
    highlights: [
      ...
      { title: "Insured & background-checked", text: "Certificate of insurance on request and a vetted team working inside your building." },
    ...
    sections: [
      ...
      { title: "Restrooms", text: "Full clean and disinfect, with paper and soap restocked from your supply." },
  ...
  warehouse: {
    ...
    highlights: [
      ...
      { title: "Restrooms & locker rooms", text: "The highest-traffic spaces in your building, cleaned, disinfected, and restocked." },
      ...
      { title: "Insured & background-checked", text: "Certificate of insurance on request and a vetted team in your facility." },
    ...
    sections: [
      { title: "Restrooms & locker rooms", text: "Toilets, urinals, sinks, showers, and floors cleaned and disinfected; supplies restocked." },
