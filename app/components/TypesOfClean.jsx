    ...
    <section id="residential">
      <div className="wrap">
        <div className="section-head reveal">
          ...
          <h2>We clean homes, too</h2>
          <p>The same checklist-driven standard we bring to businesses, for houses, apartments, and condos. Three simple services, so it never feels like a guessing game.</p>
        </div>
        ...
        <div className="types-grid types-grid-3">
        ...
        <div className="checklist-note reveal">
          ...
          <p>Every clean includes a clear checklist upfront, so you always know exactly what's covered.</p>
        </div>
      </div>
    </section>
  );
