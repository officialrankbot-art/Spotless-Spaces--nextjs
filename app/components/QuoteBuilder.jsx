      ...
      <div className="wrap">
        ...
        <div className="quote-wrap reveal" style={{maxWidth: '720px', margin: '0 auto'}}>
          <div className="quote-card">
            <form name="quote-request" data-netlify="true" netlify-honeypot="bot-field" id="quote-form">
              <input type="hidden" name="form-name" value="quote-request" />
              <div style={{position: 'absolute', left: '-9999px'}} aria-hidden="true">
                <label>Leave this field blank<input name="bot-field" tabIndex="-1" autoComplete="off" /></label>
              </div>
              <input type="hidden" name="clean-type" id="hidden-service" value="" />
              <input type="hidden" name="home-size" id="hidden-size" value="" />
              <input type="hidden" name="frequency" id="hidden-frequency" value="" />
              <input type="hidden" name="estimated-price" id="hidden-price" value="" />
              ...
              <div className="qb-step" data-step="1">
                ...
                <div className="qb-options">
                  ...
                  <div className="qb-opt" data-field="service" data-value="ResidentialStandard">
                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 014-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 01-4 4H3"/></svg>
              ...
              <div className="qb-step" data-step="2" style={{display: 'none'}}>
                <div className="qb-label">Step 2 of 4 — Bedrooms &amp; Bathrooms</div>
                <div className="qb-options cols-4" id="size-options"></div>
                <div className="qb-field" style={{marginTop: '18px'}}>
                  <label>Approx. square footage (optional — helps us double-check the estimate)</label>
                  <input type="text" name="sqft" id="q-sqft" placeholder="e.g. 1,800 sq ft"/>
                </div>
              </div>
              ...
              <div className="qb-step" data-step="4" style={{display: 'none'}}>
                ...
                <div className="qb-row2">
                  <div className="qb-field"><label>Full name</label><input type="text" name="name" id="q-name" placeholder="Jamie Rivera"/></div>
                  <div className="qb-field"><label>Phone or email</label><input type="text" name="contact" id="q-contact" placeholder="(555) 555-0100"/></div>
                </div>
                <div className="qb-row2">
                  <div className="qb-field"><label>Zip code</label><input type="text" name="zip" id="q-zip" placeholder="19107"/></div>
                  <div className="qb-field"><label>Preferred date</label><input type="date" name="date" id="q-date"/></div>
                </div>
              </div>
              ...
              <div className="qb-nav" id="qb-nav">
                ...
                <button type="button" className="btn btn-navy" id="qb-next" disabled>Continue</button>
              </div>
            </form>
          </div>
        </div>
